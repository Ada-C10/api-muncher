...
describe "Recipe" do
  it "Cannot be initialized without required parameters" do
   ...
   #
   #  expect {
   #    Recipe.new ( "Chicken", "https://www.edamam.com/web-img/262/262b4353ca25074178ead2a07cdf7dc1.jpg", "http://www.edamam.com/ontologies/edamam.owl#recipe_7bf4a371c6884d809682a72808da7dc2"
   #   )
   # }.must_raise ArgumentError
   #
   #  expect {
